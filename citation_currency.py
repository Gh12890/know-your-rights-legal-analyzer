...
CITATION_CURRENCY_MAP = {
    ...
    "dk_basu_safeguards": {
        ...
        "successor_treatment": (
            ...
            "CITATION DISCREPANCY RESOLVED 2026-09-01: the corpus record "
            "previously had '(1997) 6 SCC 642', which is the 1 Aug 1997 "
            "monitoring order actually sourced -- NOT the 18 Dec 1996 "
            "judgment, (1997) 1 SCC 416, that laid down the 11 safeguards "
            "and that every later court (incl. Sushrita Saren) cites. The "
            "sourced order quotes the requirements verbatim; the corpus "
            "'citation' field, chunk header, and build_judgment_corpus.py "
            "comment were all corrected to (1997) 1 SCC 416 with "
            "'source_document_citation' recording the 1997 order. No "
            "retrieval text changed."
        ),
        "verified_note": (
            ...
            "no adverse treatment. Citation discrepancy RESOLVED -- corpus "
            "record corrected from '(1997) 6 SCC 642' (the 1997 monitoring "
            "order sourced) to '(1997) 1 SCC 416' (the 1996 judgment that "
            "laid down the safeguards)."
        ),
